...
<template>
  <div class="breadcrumbs">
    ...
    <NavItem
      v-if="app.view !== VIEW.HOME && app.view !== VIEW.LOCK"
      :level="1"
      icon="diary"
      :title="settings.diary_name"
      @click="diaryStore.setView(VIEW.HOME)"
    />
    ...
    <NavItem
      v-if="app.view === VIEW.EDIT_NOTE"
      :level="2"
      icon="note-list"
      title="21.06.2024"
      @click="diaryStore.setView(VIEW.NOTE_LIST)"
    />
